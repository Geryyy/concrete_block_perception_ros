    ...
    return LaunchDescription(
        [
            ...
            Node(
                ...
                remappings=[
                    ("debug/registration_mask_cutout", "/cbp/debug/registration_mask_cutout"),
                    ("debug/registration_cleaned_cutout", "/cbp/debug/registration_cleaned_cutout"),
                    ("debug/registration_plane_cloud", "/cbp/debug/registration_plane_cloud"),
